...
//Removing GOEWS for necessary fixes
...
totalWidth = (Connection_Type == "GOEWS" ? 1 : slotsWide) * distanceBetweenSlots;
    ...
    union() {
        ...
        difference() {
            ...
            hull() {
                ...
                translate(v = [-(distanceBetweenSlots * slotsWide) / 2,-0.01, 0]) 
                    cube([distanceBetweenSlots * slotsWide,0.2, distanceBetweenSlots * slotsHigh]);
            }
